...
Adding labels to the level of your contour lines is now as simple as calling `geom_labelcontour` instead of `geom_contour`:
...
We also have `geom_labeldensity2d` for the common use case of 2D density contours:
...
The behaviour of the `vjust` and `hjust` parameters is described in more detail in the "aesthetics" vignette.
