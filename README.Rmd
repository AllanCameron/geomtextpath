...
We can also use `stat_smooth` to get labelled trend lines through scatterplots:
...
And of course, arbitrary functions can be labelled with paths created in `stat_function`:
