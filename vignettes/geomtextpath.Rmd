...
All of the line-based geom layers in `ggplot2` have their text equivalents and text-box equivalents in the `geomtextpath` package:
...
When a `textpathGrob` is created, it measures the dimensions of the given text label letter-by-letter and stores the result along with the x, y values of the path and any graphics parameters such as color, linewidth and font. 
